...
return  array(
    ...
    'DB_NAME'               =>  'qxappstore',          // 数据库名
    'DB_USER'               =>  'root',      // 用户名
    'DB_PWD'                =>  '123',          // 密码*/

    'DB_HOST'               =>  '120.25.13.223', // 服务器地址localhost
    'DB_NAME'               =>  'qxappstoreLine_jz0775_1',//'qxappstoreLine_jz0775_1',//'qxappstoreLine',          // 数据库名
    'DB_USER'               =>  'mstar',      // 用户名root
    'DB_PWD'                =>  'mstarpw#@$',          // 密码
    'DB_PORT'               =>  '3306',        // 端口
    ...
    'DB_PARAMS' => array(\PDO::ATTR_CASE => \PDO::CASE_NATURAL),//读取数据库输出字段不会全部变小写
